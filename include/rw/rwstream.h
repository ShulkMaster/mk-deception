...
RwStream* RwStreamWriteReal(RwStream* stream, const float* values,
                            unsigned int numBytes);
RwStream* RwStreamWriteInt32(RwStream* stream, const void* values,
                             unsigned int numBytes);
RwStream* RwStreamReadReal(RwStream* stream, float* values,
                           unsigned int numBytes);
RwStream* RwStreamReadInt32(RwStream* stream, void* values,
                            unsigned int numBytes);
