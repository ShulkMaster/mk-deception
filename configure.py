...
config.libs = [
    ...
    RenderWareLib(
        ...
        [
            ...
            Object(
                NonMatching,
                "rwcore.a/bamatrix.obj",
                source="rw/bamatrix.c",
    ...
    RenderWareLib(
        ...
        [
            ...
            Object(NonMatching, "rpworld.a/bamesh.obj", source="rw/bamesh.c",
                   extra_cflags=["-opt", "off", "-O0", "-inline", "off"]),
            Object(NonMatching, "rpworld.a/bameshop.obj",
                   source="rw/bameshop.c",
                   extra_cflags=["-opt", "off", "-O0", "-inline", "off"]),
            ...
            Object(NonMatching, "rpworld.a/geomcond.obj", source="rw/geomcond.c",
                   extra_cflags=["-opt", "off", "-O0", "-inline", "off"]),
            Object(NonMatching, "rpworld.a/instancegeom.obj",
                   source="rw/instancegeom.c",
                   extra_cflags=["-opt", "off", "-O0", "-inline", "off"]),
    ...
    RenderWareLib(
        ...
        [
            ...
            Object(NonMatching, "rpskin.a/skingcnasm.obj",
                   ...
                   extra_cflags=["-opt", "off", "-O0", "-inline", "off"]),
            Object(NonMatching, "rpskin.a/skingcn.obj",
                   source="rw/skingcn.c",
                   extra_cflags=["-opt", "off", "-O0", "-inline", "off"]),
        ],
    ),
