...
config.libs = [
    {
        ...
        "objects": [
            ...
            Object(NonMatching, "mwMemDebug.o", source="mw/mwMemDebug.c"),
            ...
            Object(NonMatching, "specular.o", source="game/specular.c", extra_cflags=["-use_lmw_stmw on"]),
            ...
            Object(NonMatching, "bgnd_jmt.o", source="game/bgnd_jmt.c"),
            ...
            Object(NonMatching, "sound.o", source="game/sound.c",
                   extra_cflags=["-use_lmw_stmw on", "-O4,s"]),
            Object(NonMatching, "nbc.o", source="game/nbc.c",
                   extra_cflags=["-O4,s", "-use_lmw_stmw on"]),
            ...
            Object(NonMatching, "gcmcardmsg.o", source="platform/gcmcardmsg.c",
                   extra_cflags=["-O4,s", "-use_lmw_stmw on"]),
            Object(NonMatching, "gcio.o", source="platform/gcio.c", extra_cflags=["-use_lmw_stmw on"]),
            Object(NonMatching, "disc_error.o", source="platform/disc_error.c"),
            Object(NonMatching, "gcutils.o", source="platform/gcutils.c", extra_cflags=["-use_lmw_stmw on"]),
            ...
            Object(NonMatching, "mwMemHeap.o", source="mw/mwMemHeap.c", extra_cflags=["-use_lmw_stmw on"]),
    ...
    },
    {
        ...
        "objects": [
            ...
            Object(
                ...
                extra_cflags=[
                    "-use_lmw_stmw on", "-inline", "deferred,level=1"
                ],
            ),
            Object(
                NonMatching,
